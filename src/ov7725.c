...
static const uint8_t default_regs[][2] = {
        ...
        {CLKRC,      0x80 |
                     0x03}, /* Res/Bypass pre-scalar (0x40:bypass, 0x00-0x3F:prescaler PCLK=XCLK/(prescaler + 1)/2 ) */
